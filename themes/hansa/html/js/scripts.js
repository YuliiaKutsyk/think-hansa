jQuery(document).ready(function($) {
    ...
    $("#category-mobile_owl").owlCarousel({
     ...
     $('.age-form_wrap .submit-form').on('click', function() {
        ...
        if (setMilisecondsCurrent >= setMiliseconds) { */
            // you are above 18
            $.cookie("popupCookie", 1, { expires : 7, path:'/' });
            $('.adult-popup').fadeOut();
        /*} else {
    ...
    $('.checkbox-label_adult').on('click', function(e) {
        e.preventDefault();
        e.stopPropagation();
       $(this).toggleClass('active');
    ...
    $('.add-delivery_button').on('click', function(e) {
        e.preventDefault();
        $('.add-new_adress_form').show();
    });

    $('.cancel-adress_button').on('click', function(e) {
        e.preventDefault();
        $('.add-new_adress_form').hide();
    });

    $('.add-card_button').on('click', function(e) {
        e.preventDefault();
        $('.add-newcard_form').show();
    });

    $('.cancel-card_button').on('click', function(e) {
        e.preventDefault();
