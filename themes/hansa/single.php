            ...
            <div class="single-country_holder">
              <div class="country-content_wrap">
                <div class="single-explore_titles">
                  <h1><?php the_title(); ?></h1>
                  <p class="event-post_date">Posted on <?php echo get_the_date('d F, Y'); ?></p>
                </div>
                ...
                <div class="author-social_wrap">
                  ...
                  <div class="share-post">
                    ...
                    <a href="#" class="copy-link tooltipped tooltipped-n m-2 p-2 border" aria-label="Copied" data-clipboard-text="<?php the_permalink(); ?>"></a>
                  </div>
                </div>
              ...
              <div class="country-content_navigation">
                ...
                ?>
                <div class="recent-posts_sidebar">
                	<?php while($query->have_posts()) { 
                		$query->the_post();
            		?>
	                  <div class="recent-post_side">
	                    <a href="<?php the_permalink(); ?>" class="recent-thumb">
	                      <img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>" class="cover-image">
	                    </a>
	                    <div class="recent-description">
	                      <p class="recent-date"><?php echo get_the_date('d F, Y'); ?></p>
	                      <h6>
